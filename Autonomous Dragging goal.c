...
task main()
{
  ...
  motor[motorA] = 100;			//robot drives backwards towards goal
  motor[motorB] = 100;
  motor[motorC] = 100;
  motor[motorD] = 100;
  wait1Msec(3500);

  motor[motorA] = 0;		//robot stops at goal
  motor[motorB] = 0;
  motor[motorC] = 0;
  motor[motorD] = 0;
  wait1Msec(200);

  servo[servo1] = 190;		//servo lowers arm
  wait1Msec(200)

  motor[motorA] = -50;			//turns slightly to the right
  motor[motorB] = 50;
  motor[motorC] = -50;
  motor[motorD] = 50;
  wait1Msec(500);

  motor[motorA] = -100;		//drives forward to scoring section
  motor[motorB] = -100;
  motor[motorC] = -100;
  motor[motorD] = -100;
  wait1Msec(3000);
